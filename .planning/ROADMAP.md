...
Plans:
- [x] Add playback controls + waveform preview to playlist suggestion clusters
- [x] Add random sampling playback (mid-track start, fixed 30–45s segments)
...
Plans:
- [x] Add approve/reject actions for playlist suggestion clusters (in-app)
- [x] Add naming field for approved clusters
- [x] Begin UI redesign foundation (dark theme, design system, header + wizard, stat/playlist cards)
- [ ] Add transparent explanations for grouping (why these tracks)
- [ ] Add incremental analysis: suggest additions to existing playlists
...
| 2. Analysis Engine & Caching | 5/6 | In progress | Baseline analyzer, SQLite cache, export, analysis UI, ANLZ waveform/rhythm extraction |
| 3. Playlist Generation | 0/TBD | Not started | - |
| 4. Verification Workflow & Playback | 3/4 | In progress | Cluster playback + waveform preview, sampling playback |
| 5. Approval & User Control | 3/5 | In progress | Approve/reject + naming UI, UI redesign foundation |
